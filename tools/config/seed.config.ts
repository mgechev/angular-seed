...
export class SeedConfig {
  ...
  protected SYSTEM_CONFIG_DEV: any = {
    ...
    paths: {
      ...
      '@angular/core': `${this.APP_BASE}node_modules/@angular/core/index.js`,
      '@angular/common': `${this.APP_BASE}node_modules/@angular/common/index.js`,
      '@angular/compiler': `${this.APP_BASE}node_modules/@angular/compiler/index.js`,
      '@angular/http': `${this.APP_BASE}node_modules/@angular/http/index.js`,
      '@angular/router': `${this.APP_BASE}node_modules/@angular/router/index.js`,
      '@angular/platform-browser': `${this.APP_BASE}node_modules/@angular/platform-browser/index.js`,
      '@angular/platform-browser-dynamic': `${this.APP_BASE}node_modules/@angular/platform-browser-dynamic/index.js`,
